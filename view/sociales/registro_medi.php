    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <p>Con el fin de conocer el estado de los tramites 
                    en curso desde el area de Sociales, 
                    se intrega este listado con información de los afiliados y su situación con respecto a Medicamentos por Subsidio Social. </p>
<div class="botones">
...
<div class="tabla">
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                <?php foreach($this->model->registro() as $r): ?>
                    <tr>
