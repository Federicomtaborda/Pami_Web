...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>Padron de afiliados</strong>
            </li>
        </ol>
    </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox-content text-center p-md">
                    ...
                    <h2><span class="text-navy"><i class="fa fa-users"></i>&nbsp;PADRÓN DE AFILIADOS - Agencia TANDIL.</span>
                     <br></h2>

                    <p>
                       Padrón correspodiente a JUNIO 2014
                    </p>
    </div>
</div>
...
<br>
            ...
            <div class="table-responsive">
                    ...
                    <tbody>
                    <?php foreach($this->model->padron_afiliados() as $r): ?>
                    <tr class="gradeX">
                        
                        <td><?php echo $r->n_afiliado; ?></td>
